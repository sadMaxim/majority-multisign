...
inst params =
  ...
  where
    wrap = let wrapValidator' f d r p = check $ f (PlutusTx.unsafeFromBuiltinData d) (PlutusTx.unsafeFromBuiltinData r) (unsafeFromBuiltinData p) in  wrapValidator' @MajorityMultiSignDatum @MajorityMultiSignRedeemer
